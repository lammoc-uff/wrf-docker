...
'open /home/lammoc/docker/volumes/WRF_out_volume/2021-12-10_00:00:00_d02.ctl'
...
'set strsiz 0.12'
'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim /home/lammoc/figuras/conjunto1/uv1000_1_2_'diaprev'_'hh'Z.gif'
...
'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim /home/lammoc/figuras/conjunto1/uv850_1_2_'diaprev'_'hh'Z.gif'
...
'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim /home/lammoc/figuras/conjunto1/uv700_1_2_'diaprev'_'hh'Z.gif'
...
'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim /home/lammoc/figuras/conjunto1/uv200_1_2_'diaprev'_'hh'Z.gif'
...
*   'set strsiz 0.12'
*   'draw string 2.7 7.94 Rodada: 10/12/2021 00GMT'
*   'draw string 5.6 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
*   'printim /home/lammoc/figuras/conjunto1/tsm_1_2_'diaprev'_'horaprev'Z.gif'
...
*   'xcbar 10.0 10.2 1.0 7.0 -line on -edge circle'
   ...
   'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim /home/lammoc/figuras/conjunto1/parnm_1_2_'diaprev'_'hh'Z.gif'
...
'set ccols 0 48 47 46 45 44 43 42 5 13 3 10 21 22 23 24 26 27 28 14'
   ...
   'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim /home/lammoc/figuras/conjunto1/t2m_1_2_'diaprev'_'hh'Z.gif'
...
*'set ccols 0 9 14 4 11 5 13 3 10 7 12 8 2 6'
   ...
   'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim /home/lammoc/figuras/conjunto1/prec_1_2_'diaprev'_'hh'Z.gif'
...
'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim /home/lammoc/figuras/conjunto1/U1000_1_2_'diaprev'_'hh'Z.gif'
...
'set rgb 21 162 189 255'
   ...
   'draw string 2.2 7.94 Rodada: 10/12/2021 00GMT'
   'draw string 5.2 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim /home/lammoc/figuras/conjunto1/U850_1_2_'diaprev'_'hh'Z.gif'
