...
'printim $FIGURAS/uv1000_1_1_'diaprev'_'hh'Z.gif'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv850_1_1_'diaprev'_'hh'Z.gif'
'c'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv700_1_1_'diaprev'_'hh'Z.gif'
'c'
...
'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
'printim $FIGURAS/uv200_1_1_'diaprev'_'hh'Z.gif'
...
*   'printim $FIGURAS/tsm_1_1_'diaprev'_'horaprev'Z.gif'
'c'
...
*   'xcbar -line on -edge circle' 
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/parnm_1_1_'diaprev'_'hh'Z.gif'
'c'
...
'set grads off'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/t2m_1_1_'diaprev'_'hh'Z.gif'
'c'
...
*   'set gxout shaded'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/prec_1_1_'diaprev'_'hh'Z.gif'
'c'
...
'set rgb 21 162 189 255'
 'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U1000_1_1_'diaprev'_'hh'Z.gif'
'c'
...
'set rgb 21 162 189 255'
 'set clevs 0 10 20 30 40 50 80 90 95 100'
   ...
   'draw string 2.4 7.94 Rodada: "$DIA_HOJE"/"$MES_HOJE"/"$ANO_HOJE" "$RODADA"GMT'
   'draw string 5.5 7.94 Previsao: 'dia'/'mes'/'aa' 'horalocal' h (Brasilia)'
   'printim $FIGURAS/U850_1_1_'diaprev'_'hh'Z.gif'
